  ...
  return (
    <>
        ...
        >
          ...
          >
            Eight classic algorithms animated step by step — with your own numbers, live
            statistics, adjustable speed and sound. Built for building intuition, made for the
            classroom.
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-stretch justify-center gap-4">
            <StatCard
              delay={1300}
              value="8"
              label="Classic algorithms, from Bubble to Radix"
              icon={
                <svg
                  width="28"
                  height="28"
